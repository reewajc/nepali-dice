...
public class DiceController {
    ...
    public ResponseEntity<?> rollDice() {
        ...
        Dice dice1 = new Dice.Builder().withFace(getDiceFace(generateRandom())).build();
        Dice dice2 = new Dice.Builder().withFace(getDiceFace(generateRandom())).build();
        Dice dice3 = new Dice.Builder().withFace(getDiceFace(generateRandom())).build();
        Dice dice4 = new Dice.Builder().withFace(getDiceFace(generateRandom())).build();
        Dice dice5 = new Dice.Builder().withFace(getDiceFace(generateRandom())).build();
        Dice dice6 = new Dice.Builder().withFace(getDiceFace(generateRandom())).build();
        ...
        Map<DiceEnum, Long> diceMap = dices
                .stream()
                .collect(Collectors
                        .groupingBy(Dice::getFace, Collectors.counting()));
